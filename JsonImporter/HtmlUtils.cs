...
namespace JsonImporter
{
    ...
    public static class HtmlUtils
    {
        ...
        public static void ExtractPlainAndParagraphs(
            string html,
            out string plain,
            out JArray paragraphs,
            out JArray contexts,
            bool includePlain = false
        )
        {
            ...
            decoded = rx.Replace(
                ...
                match =>
                {
                    ...
                    var parts = (bracket ?? string.Empty).Split(
                        new[] { '.' },
        ...
        public static (string plain, JArray paragraphs, JArray contexts) ExtractPlainAndParagraphs(
            string html
        )
        {
