...
6. For encounter features, explicitly compose every feature-used `RuleDefinitionId` and required
   ...
   register the module once. Contribute complete combatant registrations through the unified
   addition path for both initial participants and reinforcements, transfer every
