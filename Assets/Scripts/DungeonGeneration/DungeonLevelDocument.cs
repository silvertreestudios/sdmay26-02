...
namespace Game.DungeonGeneration
{
    ...
    public sealed class DungeonLevelDocument
    {
        ...
        )
        {
            ...
            Rooms = Copy(rooms, nameof(rooms));
            Doors = Copy(doors, nameof(doors));
            Stairs = Copy(stairs, nameof(stairs));
            StartCell = startCell;
            SafeCells = Copy(safeCells, nameof(safeCells));
            Objects = Copy(objects, nameof(objects));
            EncounterPlans = Copy(encounterPlans, nameof(encounterPlans));
