...
namespace Game.DungeonGeneration
{
    internal sealed class DungeonLevelJsonModel
    {
        ...
        internal static string Serialize(DungeonLevelDocument document)
        {
            DungeonLevelJsonModel model = new()
            {
                ...
                Rooms = document
                    ...
                    .ToArray(),
                Doors = document
                    .Doors.Select(door => new DoorModel
                    {
                        Id = door.Id,
                    ...
                    .ToArray(),
                Stairs = document
                    .Stairs.Select(stair => new StairModel
                    {
                        Id = stair.Id,
                ...
                Objects = document
                    .Objects.Select(item => new ObjectModel
                    {
                        Id = item.Id,
                    ...
                    .ToArray(),
                EncounterPlans = document
                    .EncounterPlans.Select(plan => new EncounterModel
                    {
                        Id = plan.Id,
                        RoomId = plan.RoomId,
        ...
        private static string StairKind(DungeonStairKind kind) =>
            kind switch
            {
                ...
                _ => throw new ArgumentOutOfRangeException(
                    nameof(kind),
                    kind,
                    "Stair kind is undefined."
                ),
            };

        private static string Threat(DungeonEncounterThreat threat) =>
            threat switch
            {
                ...
                _ => throw new ArgumentOutOfRangeException(
                    nameof(threat),
                    threat,
                    "Encounter threat is undefined."
                ),
            };

        internal sealed class GenerationModel
        {
            [JsonProperty("algorithm", Order = 0)]
            public string Algorithm { get; set; }

            [JsonProperty("runSeed", Order = 1)]
            public int RunSeed { get; set; }

            [JsonProperty("depth", Order = 2)]
            public int Depth { get; set; }

            [JsonProperty("topologyAttempt", Order = 3)]
            public int TopologyAttempt { get; set; }
        }
        ...
        internal sealed class RoomModel
        {
            ...
            [JsonProperty("minX", Order = 1)]
            public int MinimumX { get; set; }

            [JsonProperty("minZ", Order = 2)]
            public int MinimumZ { get; set; }

            [JsonProperty("maxX", Order = 3)]
            public int MaximumX { get; set; }

            [JsonProperty("maxZ", Order = 4)]
        ...
        internal sealed class DoorModel
        {
            ...
            [JsonProperty("cell", Order = 1)]
            public CellModel Cell { get; set; }

            [JsonProperty("isOpen", Order = 2)]
        ...
        internal sealed class StairModel
        {
            ...
            [JsonProperty("cell", Order = 2)]
            public CellModel Cell { get; set; }

            [JsonProperty("arrivalCell", Order = 3)]
            public CellModel ArrivalCell { get; set; }
        }

        internal sealed class ArrivalModel
        {
            [JsonProperty("start", Order = 0)]
            public CellModel Start { get; set; }

            [JsonProperty("safeCells", Order = 1)]
            public CellModel[] SafeCells { get; set; }
        }
        ...
        internal sealed class ObjectModel
        {
            ...
            [JsonProperty("rotation", Order = 3)]
            public int Rotation { get; set; }

            [JsonProperty("yOffset", Order = 4)]
            public float? YOffset { get; set; }

            [JsonProperty("state", Order = 5)]
        ...
        internal sealed class EncounterModel
        {
            ...
            [JsonProperty("roomId", Order = 1)]
            public int RoomId { get; set; }

            [JsonProperty("spawnCells", Order = 2)]
            public CellModel[] SpawnCells { get; set; }

            [JsonProperty("creatureIds", Order = 3)]
            public string[] CreatureIds { get; set; }

            [JsonProperty("threat", Order = 4)]
            public string Threat { get; set; }

            [JsonProperty("budget", Order = 5)]
            public int Budget { get; set; }

            [JsonProperty("isResolved", Order = 6)]
            public bool IsResolved { get; set; }
        }

        internal sealed class RuntimeModel
        {
            [JsonProperty("openDoorIds", Order = 0)]
            public string[] OpenDoorIds { get; set; }

            [JsonProperty("resolvedEncounterIds", Order = 1)]
            public string[] ResolvedEncounterIds { get; set; }

            [JsonProperty("defeatedCreatureIds", Order = 2)]
            public string[] DefeatedCreatureIds { get; set; }

            [JsonProperty("creatures", Order = 3)]
            public CreatureModel[] Creatures { get; set; }
            ...
            internal static RuntimeModel From(DungeonRuntimeState runtime)
            {
                ...
                return new RuntimeModel
                {
                    ...
                    Creatures = runtime
                        .Creatures.Select(creature => new CreatureModel
                        {
        ...
        {
            [JsonProperty("instanceId", Order = 0)]
            public string InstanceId { get; set; }

            [JsonProperty("creatureId", Order = 1)]
            public string CreatureId { get; set; }

            [JsonProperty("encounterId", Order = 2)]
            public string EncounterId { get; set; }

            [JsonProperty("cell", Order = 3)]
            public CellModel Cell { get; set; }

            [JsonProperty("hitPoints", Order = 4)]
