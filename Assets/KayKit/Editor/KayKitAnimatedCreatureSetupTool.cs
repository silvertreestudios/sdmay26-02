...
namespace Game.KayKit.Editor
{
    public static class KayKitAnimatedCreatureSetupTool
    {
        ...
        public const string CreatureVisualCatalogPath =
            KayKitSetupTool.CatalogRoot + "/CreatureVisualCatalog.asset";
        public const string EquipmentVisualCatalogPath =
            KayKitSetupTool.CatalogRoot + "/EquipmentVisualCatalog.asset";
        public const string AnimatorControllerPath =
            KayKitSetupTool.ProjectRoot + "/Animation/KayKitCreatureAnimator.controller";
        public const float AnimatedCreatureVisualScale = 0.50f;
        public const float CharacterPreviewVisualScale = 0.62f;

        private const string AdventurerModelRoot =
            "Assets/ThirdParty/KayKit/Adventurers_2.0/Characters/fbx";
        private const string AdventurerAccessoryRoot =
            "Assets/ThirdParty/KayKit/Adventurers_2.0/Assets/fbx(unity)";
        private const string SkeletonModelRoot =
            "Assets/ThirdParty/KayKit/Skeletons_1.1/characters/fbx";
        private const string SkeletonAccessoryRoot =
            "Assets/ThirdParty/KayKit/Skeletons_1.1/assets/fbx(unity)";
        private const string RangerMaterialPath =
            KayKitSetupTool.MaterialRoot + "/KayKitAdventurers_ranger_texture.mat";
        private const string SkeletonMaterialPath =
            KayKitSetupTool.MaterialRoot + "/KayKitSkeletons_skeleton_texture.mat";

        private static readonly VisualDefinition[] VisualDefinitions =
        {
            new(
                "RangerAnimated",
                AdventurerModelRoot + "/Ranger.fbx",
                KayKitSetupTool.MaterialRoot + "/KayKitAdventurers_ranger_texture.mat",
                KayKitRigProfile.Adventurer,
                "adventurer",
                "dogslicer"
            ),
            new(
                "BarbarianAnimated",
                AdventurerModelRoot + "/Barbarian.fbx",
                KayKitSetupTool.MaterialRoot + "/KayKitAdventurers_barbarian_texture.mat",
                KayKitRigProfile.Adventurer,
                "adventurer",
                "greataxe"
            ),
            new(
                "KnightAnimated",
                AdventurerModelRoot + "/Knight.fbx",
                KayKitSetupTool.MaterialRoot + "/KayKitAdventurers_knight_texture.mat",
                KayKitRigProfile.Adventurer,
                "adventurer",
                "longsword"
            ),
            new(
                "MageStaffAnimated",
                AdventurerModelRoot + "/Mage.fbx",
                KayKitSetupTool.MaterialRoot + "/KayKitAdventurers_mage_texture.mat",
                KayKitRigProfile.Adventurer,
                "adventurer",
                "staff"
            ),
            ...
            new(
                "RogueHoodedAnimated",
                AdventurerModelRoot + "/Rogue_Hooded.fbx",
                KayKitSetupTool.MaterialRoot + "/KayKitAdventurers_rogue_texture.mat",
                KayKitRigProfile.Adventurer,
                "adventurer",
                "dagger"
            ),
            new(
                "SkeletonMinionAnimated",
                SkeletonModelRoot + "/Skeleton_Minion.fbx",
                SkeletonMaterialPath,
                KayKitRigProfile.Skeleton,
                "skeleton",
                "unarmed"
            ),
            new(
                "SkeletonWarriorAnimated",
                SkeletonModelRoot + "/Skeleton_Warrior.fbx",
                SkeletonMaterialPath,
                KayKitRigProfile.Skeleton,
                "skeleton",
                "scimitar"
        ...
        public static void RegenerateAnimatedCreatureAssets()
        {
            try
            {
                ...
                KayKitAnimationLibrary library = RequireAsset<KayKitAnimationLibrary>(
                ...
                Dictionary<string, GameObject> prefabs = GenerateVisualPrefabs(
                    controller,
                    library,
                    equipmentCatalog
                );
        ...
        public static IReadOnlyList<string> ValidateAnimatedAssets()
        {
            ...
            CreatureVisualCatalog visualCatalog =
                AssetDatabase.LoadAssetAtPath<CreatureVisualCatalog>(CreatureVisualCatalogPath);
            ...
            if (animatorController == null)
                ...
                errors.Add(
                    "KayKit creature Action transition must allow self-entry for consecutive animations."
                );
            ...
            foreach (VisualDefinition definition in VisualDefinitions)
            {
                ...
                if (
                    prefab.GetComponent<CreatureAnimationController>() == null
                ...
                if (
                    Vector3.Distance(
                        ...
                        Vector3.one * AnimatedCreatureVisualScale
                    ) > 0.001f
                )
                    errors.Add(
                        "Animated visual is not configured at the approved combat scale: " + path
                    );
        ...
        private static AnimatorController GenerateAnimatorController(KayKitAnimationLibrary library)
        {
            ...
            controller.AddParameter(
                CreatureAnimationController.SpeedParameter,
                AnimatorControllerParameterType.Float
            );
            controller.AddParameter(
                CreatureAnimationController.ActionLoopParameter,
                AnimatorControllerParameterType.Bool
            );
            controller.AddParameter(
                CreatureAnimationController.ActionTrigger,
                AnimatorControllerParameterType.Trigger
            );
            controller.AddParameter(
                CreatureAnimationController.DeathTrigger,
                AnimatorControllerParameterType.Trigger
            );
            ...
            action.motion = GetRequiredClip(
                library,
                "animation/combatmelee/melee_unarmed_attack_punch_a"
            );
        ...
        private static void EnableActionSelfTransition(AnimatorController controller)
        {
            ...
            if (transition == null)
                throw new InvalidOperationException(
                    "KayKit creature Animator Controller is missing its Any State -> Action transition."
                );
        ...
        private static AnimatorStateTransition FindActionTransition(AnimatorController controller)
        {
            ...
            return controller
                .layers[0]
                .stateMachine.anyStateTransitions.FirstOrDefault(transition =>
        ...
        {
            EquipmentVisualCatalog catalog = GetOrCreate<EquipmentVisualCatalog>(
                EquipmentVisualCatalogPath
            );
            ...
            List<EquipmentVisualCatalogEntry> entries = new()
            {
                ...
                Entry(
                    ...
                    A("dagger.fbx", ranger, EquipmentSocket.RightHand)
                ),
                Entry(
                    "dagger",
                    "dagger",
                ...
                Entry(
                    ...
                    -1,
                    AnimationStyle.OneHandMelee,
                    A("sword_1handed.fbx", ranger, EquipmentSocket.RightHand)
                ),
                Entry(
                    "scimitar",
                    "scimitar",
                ...
                Entry(
                    ...
                    -1,
                    AnimationStyle.OneHandMelee,
                    S("Skeleton_Blade.fbx", skeleton, EquipmentSocket.RightHand)
                ),
                Entry(
                    "skeleton-scimitar",
                    "scimitar",
                ...
                Entry(
                    ...
                    A("axe_2handed.fbx", ranger, EquipmentSocket.RightHand)
                ),
                Entry(
                    "skeleton-greataxe",
                    "greataxe",
                    ...
                    -1,
                    AnimationStyle.TwoHandMelee,
                    S("Skeleton_Axe.fbx", skeleton, EquipmentSocket.RightHand)
                ),
                Entry(
                    "shortbow",
                    "shortbow",
                    ...
                    -1,
                    AnimationStyle.Bow,
                    A("bow_withString.fbx", ranger, EquipmentSocket.RightHand),
                    A("quiver.fbx", ranger, EquipmentSocket.Quiver)
                ),
                Entry(
                    "skeleton-shortbow",
                    "shortbow",
                    ...
                    AnimationStyle.Bow,
                    A("bow_withString.fbx", ranger, EquipmentSocket.RightHand),
                    S("Skeleton_Quiver.fbx", skeleton, EquipmentSocket.Quiver)
                ),
                Entry(
                    "halberd",
                    "halberd",
                    ...
                    -1,
                    AnimationStyle.TwoHandMelee,
                    A("staff.fbx", ranger, EquipmentSocket.RightHand)
                ),
                Entry(
                    "spear",
                    "spear",
                ...
                Entry(
                    ...
                    -1,
                    AnimationStyle.TwoHandMelee,
                    S("Skeleton_Staff.fbx", skeleton, EquipmentSocket.RightHand)
                ),
                Entry(
                    "skeleton-spear",
                    "spear",
                ...
                Entry(
                    ...
                    A("smokebomb.fbx", ranger, EquipmentSocket.RightHand)
                ),
                Entry(
                    "staff",
                    "staff",
                ...
                Entry(
                    ...
                    -1,
                    AnimationStyle.Magic,
                    A("wand.fbx", ranger, EquipmentSocket.RightHand)
                ),
                Entry(
                    "fallback-skeleton-sword",
                    "",
                    "skeleton",
                    "sword",
                    1,
            ...
            foreach (VisualDefinition definition in VisualDefinitions)
            {
                ...
                try
                {
                    ...
                    if (modelInstance == null)
                        throw new InvalidOperationException(
                            "Could not instantiate character model: " + definition.ModelPath
                        );
                    ...
                    if (animator == null || animator.avatar == null || !animator.avatar.isHuman)
                        throw new InvalidOperationException(
                            "Character model is not a valid Humanoid: " + definition.ModelPath
                        );
                    animator.applyRootMotion = false;
                    animator.runtimeAnimatorController = controller;
                    foreach (
                        Renderer renderer in modelInstance.GetComponentsInChildren<Renderer>(true)
                    )
                    ...
                    if (torso == null)
                        throw new InvalidOperationException(
                            "Could not resolve a Humanoid torso bone: " + definition.ModelPath
                        );
                    Transform backSocket = CreateSocket(
                        "BackSocket",
                        torso,
                        new Vector3(0, 0.05f, -0.12f)
                    );
                    Transform quiverSocket = CreateSocket(
                        "QuiverSocket",
                        torso,
                    ...
                    CreatureAnimationController animation =
                        root.AddComponent<CreatureAnimationController>();
                    animation.Configure(animator, controller, library, definition.RigProfile);
                    CreatureEquipmentVisuals equipment =
                        root.AddComponent<CreatureEquipmentVisuals>();
                    equipment.Configure(
                        animator,
                        equipmentCatalog,
                        definition.Species,
                    ...
                    if (saved == null)
                        throw new InvalidOperationException(
                            "Could not save animated visual prefab: " + path
                        );
        ...
        {
            CreatureVisualCatalog catalog = GetOrCreate<CreatureVisualCatalog>(
                CreatureVisualCatalogPath
            );
            ...
            catalog.ReplaceEntries(
                new[]
                {
                    ...
                    new CreatureVisualCatalogEntry(
                        "Zombie Shambler",
                        "skeletons/skeleton_minion",
                        "skeleton",
                        skeletonMinion
                    ),
                    new CreatureVisualCatalogEntry(
                        "Zombie Shambler (Rotting Aura)",
                        "skeletons/skeleton_minion",
                        "skeleton",
                        skeletonMinion
                    ),
        ...
        {
            string[] creaturePrefabPaths = AssetDatabase
                .FindAssets("t:Prefab", new[] { "Assets/Prefabs/Creatures" })
        ...
        {
            GameObject prefab = AssetDatabase.LoadAssetAtPath<GameObject>(path);
            TokenMeshSelection selector =
                prefab != null ? prefab.GetComponentInChildren<TokenMeshSelection>(true) : null;
            Transform expectedRoot =
                selector != null
                    ? (
                        expectPresentation
                            ? prefab.transform.Find("VisualRoot")
                            : selector.transform.Find("VisualRoot")
                    )
                    : null;
            if (
                selector == null
                || selector.VisualCatalog != expectedCatalog
                || expectedRoot == null
            )
            ...
            if (
                expectPresentation
                && prefab != null
                && prefab.GetComponent<CreaturePresentation>() == null
            )
            ...
            if (
                ...
                && Vector3.Distance(
                    ...
                    Vector3.one * CharacterPreviewVisualScale
                ) > 0.001f
            )
                errors.Add(
                    "Character preview VisualRoot scale is not configured for complete framing: "
                        + path
                );
        }
        ...
        private static void AddActionExit(
        ...
        {
            string[] missing = CreatureAnimationController
                .RequiredDefaultClipIds()
                .Where(id =>
                    !library.TryGet(id, out KayKitAnimationEntry entry) || entry.Clip == null
                )
